...
class Game
{
    ...
    constructor(player, scene, world, network_manager=new NetworkManager("ws://localhost:5173")) { // Don't think we should be passing player here, think it should be generated by a method of the class
        this.player = player;
        this.scene = scene;
        this.world = world;
...
let game = new Game(player, scene, world);
game.start();
